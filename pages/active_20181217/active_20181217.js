...
Page({
  data: {
    ...
    url:`${h5Active}wx_webview/active_20181217/index.html?a=1`,
    shareLayer:false,
		layerBanner:'',
    layerLabel:'',
    layerTips:'',
  ...
  onShareAppMessage: function (res) {
    ...
    baseShare(_this);
    var shareObj = {
      title: '鞠婧祎、霍尊、张云雷喊你一起决战国风',
      desc: '拍照就能造型，为你量身打造适合你的发型',
      path: `/pages/active_20181217/active_20181217?shareUserId=${user_id}&scene=${getUrl()}`,
